        ...
        <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-gray-50 to-blue-50">
          ...
          <div className="absolute bottom-24 left-12 w-32 h-32 opacity-20">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              ...
              {/* Triangle */}
              <path
                d="M160 140 L170 120 L180 140 Z"
                fill="#c4b5fd"
                opacity="0.7"
              />
            </svg>
          ...
          <div className="absolute top-16 right-12 w-32 h-32 opacity-20">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              ...
              {/* Brain icon */}
              <path
                d="M120 100 C130 90, 140 90, 150 100 C140 110, 130 110, 120 100"
                fill="#fca5a5"
                stroke="#f87171"
                strokeWidth="2"
              />
          ...
          <div className="absolute bottom-24 right-12 w-32 h-32 opacity-20">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              ...
              {/* Light rays */}
              <path
                d="M60 60 L70 50 L80 60"
                stroke="#fde047"
                strokeWidth="2"
                fill="none"
              />
              <path
                d="M120 60 L130 50 L140 60"
                stroke="#fde047"
                strokeWidth="2"
                fill="none"
              />
              <path
                d="M60 100 L50 90 L60 80"
                stroke="#fde047"
                strokeWidth="2"
                fill="none"
              />
              <path
                d="M140 100 L150 90 L140 80"
                stroke="#fde047"
                strokeWidth="2"
                fill="none"
              />
              ...
              {/* Arrow heads */}
              <path
                d="M65 95 L70 100 L65 105"
                stroke="#3b82f6"
                strokeWidth="2"
                fill="none"
              />
              <path
                d="M135 105 L130 100 L135 95"
                stroke="#3b82f6"
                strokeWidth="2"
                fill="none"
              />
          ...
          <div className="absolute bottom-1/4 left-1/2 w-6 h-6 opacity-5">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              <path
                d="M50 120 L50 80 L30 100 L50 120 L70 100 Z"
                fill="#9ca3af"
              />
            </svg>
          </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Transform your data collection with intelligent forms powered by
              AI. Create, analyze, and optimize surveys that deliver actionable
              insights.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 lg:p-8 shadow-lg transition-shadow duration-300 border border-gray-100">
              ...
              <p className="text-gray-700 italic">
                "InsightForm revolutionized our customer feedback process. The
                AI-powered analysis helped us increase response rates by 40% and
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 lg:p-8 shadow-lg transition-shadow duration-300 border border-gray-100">
              ...
              <p className="text-gray-700 italic">
                "The advanced survey features and real-time analytics have
                transformed how we collect and process data. Our team
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 lg:p-8 shadow-lg transition-shadow duration-300 border border-gray-100">
              ...
              <p className="text-gray-700 italic">
                "InsightForm's intelligent form builder and automated analysis
                features have streamlined our research processes and improved
      ...
      <section className="py-16 bg-gray-50">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                title: "Advanced Survey Creation",
                desc: "Build sophisticated surveys with conditional logic, multiple question types, and custom styling to capture the data you need.",
                icon: (
                  <path
                    strokeLinecap="round"
              ...
              },
              {
                ...
                desc: "Leverage AI to optimize form design, predict user behavior, and automatically improve question flow for better responses.",
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              },
              {
                ...
                desc: "Get instant insights with real-time analytics, automated reports, and data visualization tools for informed decisions.",
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              },
              {
                ...
                desc: "Work together with team members, share forms, and collaborate on data analysis in real time.",
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              },
              {
                ...
                desc: "Bank-level encryption, GDPR compliance, and advanced security to protect your data.",
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              },
              {
                ...
                desc: "Connect with your favorite tools via our API and pre-built integrations.",
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div
                key={i}
                className="bg-white rounded-xl p-5 shadow-lg transition-shadow duration-200 border border-gray-100"
              >
      ...
      <footer className="bg-blue-600 border-t border-blue-500 w-full mt-8">
        <div className="w-full py-10 px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-100 mb-6 max-w-md">
                Transform your data collection with intelligent forms powered by
                AI. Create, analyze, and optimize surveys that deliver
                actionable insights.
              </p>
            ...
            {/* Contact Info */}
            <div>
              <h3 className="text-lg text-gray-100 font-semibold mb-4">
                Contact Us
              </h3>
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link
                  to="/about"
                  className="block text-gray-100 hover:text-gray-900 transition-colors"
                >
                  About Us
                </Link>
                <Link
          ...
          <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-100">
            <p>
              &copy; 2025 InsightForm. All rights reserved. | Privacy Policy |
              Terms of Service
            </p>
          </div>
        </div>
