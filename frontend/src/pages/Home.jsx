...
const Home = () => {
    ...
    return (
        <div className="min-h-screen w-full overflow-x-hidden">
            ...
            {/* Footer */}
            <footer className="bg-gray-400 border-t border-blue-500 w-full mt-8">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-3 text-gray-600">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span>Surathkal, Mangalore, NITK</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                <Link to="/signup" className="block text-gray-600 hover:text-gray-900 transition-colors">Sign Up</Link>
                            </div>
                        </div>
                    </div>
